...
2. Dice Rules //in GameController.java
...
3. MAGIC Area (Orange Area) Rules //in Player.java
...
4. Booster Rules //in ControlPanel.java
...
- Custom Player name : GameController.java
- Change Background : BoardPanel.java
- Change Tunnel : Board.java
- Add Button , Label : ControlPanel.java
